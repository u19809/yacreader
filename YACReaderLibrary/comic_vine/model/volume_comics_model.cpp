...
QVariant VolumeComicsModel::headerData(int section, Qt::Orientation orientation,
                                       int role) const {
...
QModelIndex VolumeComicsModel::index(int row, int column,
...
void VolumeComicsModel::addExtraRows(int numRows) { numExtraRows = numRows; }
